        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <form action="nova_empresa.php" method="post">
                    ...
                    <div class="form-group" id="divTelefoneEmpresa">
                        <label>Telefone/Whatsapp:</label>
                        <input class="form-control" placeholder="Digite Telefone/Whatsapp da Empresa (Opcional!)." name="telefone" id="telefoneEmpresa" maxlength="12"/>
                    </div>
                    <div class="form-group" id="divEnderecoEmpresa">
                        <label>Endereço:</label>
                        <input class="form-control" placeholder="Digite Endereço da Empresa (Opcional!)." name="endereco" id="enderecoEmpresa" maxlength="100"/>
                    </div>
