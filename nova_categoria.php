        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <form action="nova_categoria.php" method="post">
                    <div class="form-group" id="divNomeCategoria">
                        <label>Nome da Categoria:</label>
                        <input class="form-control" placeholder="Digite Nome da Categoria. Exemplo: Conta de Internet..." name="nome_categoria" id="nomeCategoria" onchange="ValidarCampoCategoria()" maxlength="35"/>
                    </div>
