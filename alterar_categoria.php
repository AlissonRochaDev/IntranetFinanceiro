            ...
            <div id="page-inner">
                ...
                <form action="alterar_categoria.php" method="post">
                    ...
                    <div class="form-group" id="divCategoria">
                        ...
                        <input class="form-control" placeholder="Nome da Categoria..." name="nomecategoria" id="nomeCategoriaAlterar" onchange="ValidarCampoCategoriaAlterar()" value="<?= $dados[0]['nome_categoria'] ?>" maxlength="35"/>
                    </div>
                    
                    <button type="submit" class="btn btn-success" name="btnSalvar" onclick="return ValidarCategoriaAlterar()">Salvar</button>
