...
<nav class="navbar-default navbar-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
            ...
            <li>
                <a href="#"><i class="fa fa-table fa-3x"></i>Categoria<span class="fa arrow"></a>
            ...
            <li>
                <a href="#"><i class="fa fa-bank fa-3x"></i>Empresa<span class="fa arrow"></a>
                <ul class="nav nav-second-level">
                    <li>
            ...
            <li>
                <a href="#"><i class="fa fa-money fa-3x"></i>Conta<span class="fa arrow"></a>
                <ul class="nav nav-second-level">
                    <li>
            ...
            <li>
                <a href="#"><i class="fa fa-desktop fa-3x"></i>Movimento<span class="fa arrow"></a>
                <ul class="nav nav-second-level">
                    <li>
